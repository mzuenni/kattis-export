...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[anchor=south] at (0.2,-0.3) {
    \includegraphics[height=2.2cm]{hyacinth.png}
  };
  \stemtag{0.2}{0.12}{1}{1}{-1}
