...
/*
* Cornercase: didn't read the last line
*/

public class MillingEgorDontTakeMaxS {
    public static void main(String[] args)throws Exception{
        new MillingEgorDontTakeMaxS().run();
    }
	...
	private void run() throws Exception{
		  ...
		  int S=Math.min(Integer.parseInt(ws[1]),9999); //<--- here we go
