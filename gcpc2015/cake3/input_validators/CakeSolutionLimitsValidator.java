...
/*
 *   checks whether the resulting s lies between 2 and 1000
 */
public class CakeSolutionLimitsValidator {
	
	public static void main(String[] args) throws Exception{
        new CakeSolutionLimitsValidator().run();
    }
