...
/**
 * variation of CakeStefanBinary but with linear search and bigger step in order to pass time limit
 */
public class CakeLinearSearchBiggerStep {
	public static void main(String[] args) {
		...
		while(true) {
			double aTmp = cutAreaRatio(vertices, min);
			if(aTmp <= 1-a) 
				break;
			min+=5e-4;
		}
