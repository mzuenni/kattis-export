...
/*
 * a quick check, whether the test cases are enough
 */
public class CakeEgorDiscardLast {
	
	public static void main(String[] args) throws Exception{
        new CakeEgorDiscardLast().run();
    }
	...
	private void run() throws Exception{
		  ...
		  int N=Math.min(99,Integer.parseInt(an[1]));//<-- here we go, don't take the last
