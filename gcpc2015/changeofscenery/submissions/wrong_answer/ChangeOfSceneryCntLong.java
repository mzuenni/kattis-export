...
public class ChangeOfSceneryCntLong {
	
	public static void main(String[] args)throws Exception{
        new ChangeOfSceneryCntLong().run();
    }
...
//skipp the line:
		  ...
		  long res=dijkstra(graph, 0, N-1);
		  System.out.println(res==1L? "no":"yes");
	}
	...
	long dijkstra(List<Edge>[] graph, int start, int goal){
		  int N=graph.length;
		  int[] costs=new int[N];
