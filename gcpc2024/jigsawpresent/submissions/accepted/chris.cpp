...
int main() {
    ...
    for(auto [x,y,mask,sub] : diffs1) {
        ...
        rep(i,28) {
            ...
            if((1<<i)&sub2) p1.push_back(i+n/2);
            else if((1<<i)&mask2) p2.push_back(i+n/2);
        }
