...
public class OneWayInOneClassDinitz {
	FlowNetwork fn;
	int[] indegrees;
...
//	    Arrays.fill(this.Q, 0);	// XXX not necessary since we start overwriting from the beginning.
	...
	public OneWayInOneClassDinitz(FlowNetwork fn, int[] indegrees) {
		this.fn = fn;
...
//			System.out.println("Generate rev. indexing scheme.");
			...
			OneWayInOneClassDinitz ow = new OneWayInOneClassDinitz(fn, indegrees);
