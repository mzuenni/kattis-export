...
#problem: optimization gone wrong due to a mix-up it is not possible to go to a node and than directly back
...
for i in range(n):
    ...
    for _ in range(m):
        ...
        for parent in range(n):
            if parent+1 not in forbidden and parent!=x: #should be parent!=i
