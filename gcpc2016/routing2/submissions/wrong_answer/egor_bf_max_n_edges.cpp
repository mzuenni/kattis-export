...
//tries to avoid O(n^4) by assuming that there are only n edges on the minimal way (resulting in O(n^3))
...
int main(){
    ...
    //do bellman ford:
    for(size_t i=0;i<=n;i++){//wrong there could be more than n edges in the path!    
