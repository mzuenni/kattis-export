...
/*
 ...
 however the test case with  max, max-1, max-2, .... , max-k, min with max = -1 mod min seems to take care of this solution...
 
 */

public class EgorDPSortDescending {
	public static void main(String[] args)throws Exception{
        ...
        int MAX=gs[N-1];//take the smallest
