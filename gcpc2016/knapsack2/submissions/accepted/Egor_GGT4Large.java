...
for K>G_max*G_max holds:
   ...
   Thus, by using ggt for K>1_000_000 (if G_max is 1_000) and brute force otherwise, this solution is OK
*/

public class Egor_GGT4Large {
	public static void main(String[] args)throws Exception{
        ...
        boolean loot = (K<1_000_000L) ? bruteForce(gs, (int)K) : withGGT(gs, K);
