...
\displaysample{dungeoncrawler/problem_statement/1}
\displaysample{dungeoncrawler/problem_statement/2}
\displaysample{dungeoncrawler/problem_statement/3}

\vspace{4mm}
In the example interactions above, the output of the grader is on the
left and one possible correct output of a submission is on the right.\\
The empty lines on both sides only serve to emphasise the
chronological order of requests and answers. The grader will never
output any empty lines.
