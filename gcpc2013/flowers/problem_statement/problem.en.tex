...
The first line contains a decimal number $0 < V \le 10^5$, the optimal size for Tom's favorite flower, and an integer $0 < N \le 5$, the number of flower pots available.

The next $N$ lines each contain three decimal numbers describing the corresponding $k$th flower pot: $0 \le a_k \le 10$, $0 \le b_k \le 10$, and $1 \le h_k \le 10$.
